...
> A1–A7 + B1–B2 built in session 9 (v0.12.0) — checkboxes close after live verification (C2).

- [ ] **A1. Campaign-type chooser + single 5-step SP create flow** — Choose Campaign Type modal
...
- [ ] **A2. Rule builder depth** — grouped Rule-Type chooser modal (Advertising / Harvest / ASIN /
...
- [ ] **A3. Filter text operators** — Contains(or) · Contains(and) · Not Contains · Is · Is Not ·
      Start with (everywhere text filters appear).
- [ ] **A4. Dimensions** — add **Placement** and **Campaign Type (Drill-down)** group-bys to the
      Campaign grid.
- [ ] **A5. Bulk Operations spreadsheet page ("Pacvue XL")** — dedicated page, 6 tabs (Create/Update
...
- [ ] **A6. Column-preset names** — Target ACOS View · Performance · Default Plan · Custom Columns.
- [ ] **A7. Date presets** — add the **"Exclude latest 2 days"** variants (7 / 14 / 30 days).

## B. Goal Center (new — not yet specced)

- [ ] **B1. Live audit** — capture Pacvue's Goals feature on product.pacvue.com (Crump account) and
...
- [ ] **B2. Build** — Goal Center in the clone per §10 (goal create/edit, target ACoS/ROAS/spend,
